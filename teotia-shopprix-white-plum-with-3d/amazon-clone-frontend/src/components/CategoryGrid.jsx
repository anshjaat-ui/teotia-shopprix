...
export default function CategoryGrid() {
  return (
    <div className="bg-luxe-bg px-4 py-8">
      <h2 className="text-slate-900 text-lg font-semibold mb-4 max-w-7xl mx-auto">Shop by Category</h2>
        ...
        {tiles.map(t => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/15 to-transparent flex items-end p-3">
              <span className="text-white text-sm font-medium drop-shadow-sm">{t.title}</span>
            </div>
          </div>
        ))}
      </div>
