...
export default function HeroSlider() {
  ...
  return (
    <section className="bg-white">
      ...
      <div className="relative w-full aspect-[16/5] min-h-[180px] sm:min-h-[260px] md:min-h-[360px] overflow-hidden bg-white">
        {slide.type === 'video' ? (
          <video key={slide.url} src={slide.url} autoPlay muted loop playsInline className="block w-full h-full object-cover" />
        ) : (
          <img key={slide.url} src={slide.url} alt="Teotia Shopprix offer banner" loading="eager" className="block w-full h-full object-cover" />
        )}
