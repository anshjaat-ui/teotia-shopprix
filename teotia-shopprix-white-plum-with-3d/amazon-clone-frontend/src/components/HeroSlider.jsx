  ...
  return (
    <section className="bg-white">
      ...
      <div className="relative w-full overflow-hidden bg-white">
        {slide.type === 'video' ? (
          <video key={slide.url} src={slide.url} autoPlay muted loop playsInline className="w-full h-auto max-h-[510px] object-contain" />
        ) : (
          <img key={slide.url} src={slide.url} alt="Teotia Shopprix offer banner" loading="eager" className="w-full h-auto max-h-[510px] object-contain" />
        )}
