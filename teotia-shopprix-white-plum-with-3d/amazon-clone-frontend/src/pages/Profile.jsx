...
import { UserCircle, Mail, ShieldCheck, CalendarDays, MapPin, Package, Heart, Pencil, Save, X, Plus, Trash2, Star, Phone, CheckCircle2 } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-3xl border border-[#E9E4EF] shadow-sm overflow-hidden mb-5">
          ...
          <div className="p-5 sm:p-7 flex flex-col lg:flex-row lg:items-center gap-5">
            <div className="w-20 h-20 rounded-2xl bg-[#F7F1FB] border border-[#E9E4EF] flex items-center justify-center shrink-0">
