            ...
            return (
              <div key={s._id} className="bg-luxe-panel border border-gold/20 rounded-lg p-5">
                ...
                <div className="space-y-1 text-sm text-gray-300 mb-4">
                  ...
                  <div className="flex justify-between"><span>Monthly Payout:</span><span className="text-white">₹{(s.monthlyPayout || 0).toLocaleString('en-IN')} × {s.durationMonths - 1} months</span></div>
                  <div className="flex justify-between"><span>Last Month Bonus:</span><span className="text-white">₹{(s.finalPayout || 0).toLocaleString('en-IN')}</span></div>
                  <div className="flex justify-between font-medium border-t border-gold/10 pt-1"><span className="text-green-400">Total You Get Back:</span><span className="text-green-400">₹{(s.totalReturn || 0).toLocaleString('en-IN')}</span></div>
                </div>
                ...
                {!enrollment ? (
                  ...
                  <div className="border-t border-gold/10 pt-3">
                    ...
                    <p className="text-xs text-gray-500 mb-2">₹{(paidOutCount * (s.monthlyPayout || 0)).toLocaleString('en-IN')}+ already paid out</p>
