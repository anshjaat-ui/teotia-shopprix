    ...
    try {
      ...
      if (user) {
        try {
          ...
          // Enrollments fail hone se poora page block nahi hona chahiye
  ...
  if (error) {
    return (
      <main className="bg-luxe-bg min-h-[60vh] flex flex-col items-center justify-center gap-2 font-sans px-4 text-center">
        ...
        <p className="text-gray-500 text-xs">Backend deploy hua hai aur naye routes register hain, confirm karo.</p>
      </main>
    )
  }
