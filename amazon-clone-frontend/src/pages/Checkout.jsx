          ...
          <div className="bg-luxe-panel border border-gold/20 rounded-lg p-6 text-center">
            {claimed ? (
              <div className="py-8">
                ...
                <p className="text-white font-medium">Payment claim bhej diya gaya!</p>
                <p className="text-sm text-gray-400 mt-1">Redirecting to your orders...</p>
              </div>
            ) : (
              <>
                <h1 className="text-xl font-medium text-white mb-1">Scan & Pay</h1>
                ...
                <a href={paymentInfo.upiLink} className="block mt-3 bg-gold hover:bg-gold-light text-black rounded-full py-2 text-sm font-medium">
                ...
                <div className="text-left mt-6 border-t border-gold/10 pt-4">
                  ...
                  <input
                    ...
                    className="w-full bg-black/40 border border-gold/30 text-white rounded-sm px-2 py-1.5 text-sm mb-2"
                  />
                  <button
                    onClick={handleClaimPayment}
                    disabled={claiming}
                    className="w-full bg-gold hover:bg-gold-light text-black rounded-full py-2 text-sm font-medium disabled:opacity-60"
                  >
    ...
    <main className="bg-luxe-bg min-h-[70vh] font-sans">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 py-6">
        <form onSubmit={handlePlaceOrder} className="lg:col-span-2 bg-luxe-panel border border-gold/20 p-5 rounded-lg space-y-3">
          ...
          <h1 className="text-xl font-medium text-white mb-2">Shipping Address</h1>
          ...
          <div className="border-t border-gold/10 pt-3">
            ...
            {appliedCoupon ? (
              ...
              <div className="flex gap-2">
                <input value={couponInput} onChange={(e) => setCouponInput(e.target.value.toUpperCase())} placeholder="Enter coupon code" className="flex-1 bg-black/40 border border-gold/30 text-white rounded-sm px-2 py-1.5 text-sm" />
          ...
          <div className="border-t border-gold/10 pt-3">
            ...
            <div className="space-y-2">
              {settings?.qrUpiEnabled !== false && (
                <label className="flex items-center gap-2 bg-black/20 border border-gold/20 rounded-md px-3 py-2 cursor-pointer">
