  ...
  return (
    <footer className="bg-[#481F72] text-white mt-8 font-sans border-t border-white/15">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 px-6 py-10 text-sm">
        ...
        <div>
          <h4 className="font-bold text-[#FEA3B6] mb-3">Shop With Us</h4>
          <ul className="space-y-2 text-white/75">
            <li><Link to="/gallery" className="hover:text-[#FEA3B6]">Gallery</Link></li>
            <li><Link to="/wishlist" className="hover:text-[#FEA3B6]">Wishlist</Link></li>
            <li><Link to="/cart" className="hover:text-[#FEA3B6]">Your Cart</Link></li>
            <li><Link to="/orders" className="hover:text-[#FEA3B6]">Track Orders</Link></li>
          </ul>
        </div>
        <div>
