                ...
                {!enrollment ? (
                    ...
                    {enrollment.depositClaimed ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-gold/30 text-slate-900 rounded-md px-2 py-1.5 text-xs"
                        />
                  ...
                  <div className="border-t border-gold/10 pt-3">
                    ...
                    {showResult && lastRedeemed.coupons.length > 0 && (
                      <div className="bg-gold/30 border border-gold/20 rounded-md p-2 mb-3 space-y-1">
