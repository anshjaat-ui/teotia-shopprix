          ...
          {products.map((p) => (
            ...
            >
              <button
                ...
                className="absolute top-2 right-2 z-10 w-8 h-8 rounded-full bg-gold/50 flex items-center justify-center hover:scale-110 transition-transform"
              >
              ...
              <button
                ...
                className="mt-auto bg-gold hover:bg-gold-light hover:scale-[1.02] text-white text-sm font-semibold py-2 rounded-full transition-all"
              >
                Add to Cart
              </button>
            </div>
